    ...
    // <>
      <div className="team-section">
        ...
        <div className="quotes">
          <p>
            There's something for everyone in Jordan...you just have to know
            where to look.
            <img
              width="50px"
              height="50px"
        ...
        <div className="section" id="p1">
          ...
          <p>
            ...
            dreamer 💭 , a regular IT events participant 💻 and a casual
            volunteer
          </p>
        </div>
        ...
        <div className="section" id="p3">
          ...
          <span className="border"></span>
          <p>
            Computer Engineer 💻Learning how to be specialized in web
            development.
          </p>
        </div>
